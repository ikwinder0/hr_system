						...
						<div class="row">
							<div class="col-md-12">
								<label class = "checkbox-inline mr-4">
									<input type = "checkbox" class="process_interview" id = "inlineCheckbox1" value = "2" <?php echo($interview['status'] > 1 && $interview['status'] <= 5) ? 'disabled' : '';  ?>> Pre-Screening
								 </label>
								 <label class = "checkbox-inline mr-4"> 
									<input type = "checkbox" class="process_interview" id = "inlineCheckbox2" value = "3" <?php echo($interview['status'] > 2  && $interview['status'] <= 5 || $interview['status'] < 3) ? 'disabled' : '';  ?>> Interview
								 </label>
								 <label class = "checkbox-inline mr-4">
									<input type = "checkbox" class="process_interview" id = "inlineCheckbox3" value = "4" <?php echo($interview['status'] > 3  && $interview['status'] <= 5 || $interview['status'] < 4) ? 'disabled' : '';  ?> > Feedback
								 </label>
								 <label class = "checkbox-inline">
									<input type = "checkbox" class="process_interview" id = "inlineCheckbox4" value = "5" <?php echo($interview['status'] == 5 || $interview['status'] < 5) ? 'disabled' : '';  ?> > Result
								 </label>
							</div>
						</div>
