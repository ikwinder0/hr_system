						...
						<div class="row">
							<div class="col-md-12">
								<label class = "checkbox-inline mr-4">
									<input type = "checkbox" class="process_interview" id = "inlineCheckbox1" data-id="<?= $user_id ?>" value = "2" <?php echo($interview['status'] > 1 && $interview['status'] <= 5) ? 'disabled' : '';  ?>> Pre-Screening
								 </label>
								 <label class = "checkbox-inline mr-4"> 
