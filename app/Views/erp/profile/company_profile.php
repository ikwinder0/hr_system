  ...
  <div class="col-lg-4">
    <div class="card user-card user-card-1">
      ...
      <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab" role="tablist" aria-orientation="vertical"> 
        ...
        <a class="nav-link list-group-item list-group-item-action" id="company-document-tab" data-toggle="pill" href="#company-document" role="tab" aria-controls="company-document" aria-selected="false"> <span class="f-w-500"><i class="feather icon-mail m-r-10 h5 "></i>
