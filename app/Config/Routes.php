...
$routes->get('erp/update-documents/(:segment)', 'Employees::update_docs', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/candidate-other-info/(:segment)', 'Employees::candidate_other_info', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// awards
...
$routes->get('erp/result-save/', 'Recruitment::result_save', ['namespace' => 'App\Controllers\Erp','filter' => 'superauth']);
$routes->get('erp/feedback-save/', 'Recruitment::feedback_save', ['namespace' => 'App\Controllers\Erp','filter' => 'superauth']);
